<header class="social">
    ...
    <div class="top_wrap">
        <div class="hamburger-menu">
            ...
            <ul class="menu__box">
                ...
                <a id="to_social_link" style="display:flex; align-items: center;" href="{{route('social.home')}}">
                    <p>
                        <i>
                                    <span style="color: #66a2e5" class="menu__item">
                            Соц. сеть
                        </span>
        ...
        <div class="header_logo_wrap">
            ...
            <a id="on_public_link" class="main_link" style="display:flex; align-items: center;"
               href="{{route('social.home')}}">
                ...
                <div class="company_wrap">
                    <p>
                        <i>
                            <span class="company_name">Первая Книга</span>
                            <span class="company_desc">
                           Социальная сеть
                        </span>
            ...
            <a class="company_social_desc" href="{{route('homePortal')}}">
                <p>
                    <i>
                                    <span
            ...
            <div class="account">
                @guest
                    @if (Route::has('register'))
                        <a id="a_modal_login" href="{{route('collections')}}" class="menu_link">
                    ...
                    @endif
                @else
                    <a class="menu_link" href="{{route('collections')}}">
                        <div class="not-bell">
                            <svg id="Слой_1" data-name="Слой 1" xmlns="http://www.w3.org/2000/svg"
                                 viewBox="0 0 512 512">
                                <path
    ...
    {{----}}
    @if($user)
        <x-social.user-page-header-scrolled :user="$user"></x-social.user-page-header-scrolled>
    @endif
