...
<div class="w-full relative">
    ...
    @else
        <img src="{{$ownBook->getFirstMediaUrl('cover_front', 'thumb')}}" class="w-56 rounded-lg"
             alt="">
    @endif
</div>

<p class="font-normal line-clamp-1">{{$ownBook['title']}}</p>
<span class="text-xl italic text-dark-200 mt-auto line-clamp-1">{{$ownBook['author']}}</span>
</a>
