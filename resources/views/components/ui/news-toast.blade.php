...
<div
    ...
    class="fixed bottom-4 left-4 right-4 sm:left-auto sm:right-auto max-w-3xl z-[9999]"
    style="display: none;"
    role="status"
    aria-live="polite"
>
        ...
        <div class="relative flex gap-4">
            <div class="min-w-0">
                ...
                <div class="mt-3 flex items-center gap-3">
                    <x-ui.link href="{{ $attributes->get('href', '#') }}" data-check-logged class="!text-lg !py-0">{{$buttonText}}</x-ui.link>
                    <button
                        type="button"
                        @click="close()"
...
<style>
    @keyframes shadowPulse {
        0%, 100% {
            box-shadow:
                0 0 8px rgba(71,175,152,0.35),
                0 0 0 rgba(71,175,152,0);
        }
        50% {
            box-shadow:
                0 0 25px rgba(71,175,152,0.55),
