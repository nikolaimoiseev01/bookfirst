    ...
    <div class="mb-8 flex gap-12 lg:flex-col lg:text-center lg:items-center">
        ...
        <div class="flex flex-col gap-4 lg:items-center w-full">
            <div class="flex flex-wrap gap-4 justify-between items-center w-full md:text-center md:justify-center">
                ...
                <x-ui.tooltip-wrap text="В большом блоке на главной странице портала книги появляются в рамках выбора 2-го варианта продвижения при оформлении заявки (в случайном порядке)">
            ...
            <div class="flex gap-2 items-center md:text-center md:justify-center">
                ...
                <x-ui.link-simple :isLivewire="false" target="_blank" href="{{route('social.user', ['id' => $mainOwnBook['user_id']])}}">{{$mainOwnBook['author']}}</x-ui.link-simple>
            </div>
