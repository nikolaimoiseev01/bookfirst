<nav x-data="" class="px-4 flex flex-col gap-2 py-4 border-r bg-white border-dark-100 sm:border-r-0 sm:border-t sm:fixed sm:bottom-0 sm:left-0 sm:w-full sm:flex-row sm:max-w-svw sm:overflow-auto sm:py-2 scrollbar-none sm:z-10 sm:justify-between">
