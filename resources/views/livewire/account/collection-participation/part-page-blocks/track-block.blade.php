<div class="part track_block_wrap" id="print_part">
    ...
    <div class="block_wrap container">
        ...
        <div class="info_wrap">
            ...
            @elseif($collection['col_status_id'] === 3) {{-- Если сборник начал печататься --}}
            <p class="no-access">
            ...
            @elseif($collection['col_status_id'] < 9) {{-- Если был заказ, но сборник еще не конец--}}
            ...
            @elseif ($participation->printorder['paid_at'] ?? null) {{-- Если уже оплачен--}}
            <div class="no-access">
