<div class="part vote_block_wrap">
    ...
    <div class="block_wrap container">
        ...
        <div class="info_wrap">
            ...
            @elseif ($collection['col_status_id'] >= 2 && $participation['pat_status_id'] <= 2) {{-- Если сборник поехал, но клиент не прошел оплату --}}
            <span class="no-access">
                    Сейчас идет голосование на лучшего автора,
                    но из-за отсутствия оплаты Вы не были включены в список участников.
                </span>
