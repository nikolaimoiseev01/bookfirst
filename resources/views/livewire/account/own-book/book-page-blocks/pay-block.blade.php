    ...
    <div class="block_wrap container">
        ...
        <div class="info_wrap">
            ...
            <div class="need_to_pay_wrap">
                ...
                @elseif ($own_book['own_book_status_id'] === 99)
                    <p class="no-access">
                        Данное издание больше неактуально. Если у вас возникнут вопросы, почему появился такой статус, вы все еще можете использовать чат выше.
                    </p>
                @else
                    ...
                    <p class="pay_parts_text">*На данном этапе оплата производится за все услуги, кроме печати, так как
                        цена
