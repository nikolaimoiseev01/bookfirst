...
// ------------------------------// Works Adding---------------------------------------------
        ...
        {{--Пошли на передачу параметров в LiveWire--}}
        <script>
