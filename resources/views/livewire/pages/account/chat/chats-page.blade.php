            ...
            <div class="flex flex-col px-4 flex-1 relative">
                ...
                <div class="flex flex-col">
                    ...
                    @if($cur_chat->ownBook ?? null)
                        <x-ui.link-simple href="{{route('account.own_book.index', $cur_chat->ownBook['id'])}}"
                                          class="text-lg"> На
                            страницу издания
                        </x-ui.link-simple>
                    @elseif($cur_chat->participation ?? null)
                        <x-ui.link-simple href="{{route('account.participation.index', $cur_chat->participation['id'])}}"
                                          class="text-lg">
                            На страницу издания
                        </x-ui.link-simple>
