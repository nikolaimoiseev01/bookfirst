<div class="mb-16 max-w-5xl">
    ...
    <x-ui.link-simple href="{{route('portal.help.own_book')}}" class="mb-4">Инструкция по этой
        странице
    </x-ui.link-simple>
    <div
        class="mb-8 px-4 py-2 flex justify-between items-center gap-4 border rounded-2xl border-green-500 flex-wrap md:flex-col">
    ...
    @if($ownBook['status_general'] == \App\Enums\OwnBookStatusEnums::DONE)
        <div class="mb-8 border rounded-2xl border-green-500 flex-wrap md:flex-col px-4 py-2">
            <p class="font-medium">Мы поздравляем вас с изданием собственной книги!
