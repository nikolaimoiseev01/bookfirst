<main class="flex-1 content mb-32">
    ...
    @endsection
        <nav class="flex gap-2 mb-12 flex-wrap">
            <x-ui.link-simple href="{{route('portal.own_books.released')}}">Собственные книги</x-ui.link-simple>
            <p>/</p>
            <p>{{$ownBook['title']}}</p>
        </nav>
        ...
        <div class="flex flex-col gap-4 lg:items-center">
            ...
            @if($ownBook['annotation'])
                <p>Кроме составления различных литературных сборников мы также предлагаем составить Вашу собственную
                    ...
                    заканчивая регистрацией книги, присвоения ей уникального номера ISBN, а также ее размещение на
                    всемирных
                    книжных интернет площадках (Amazon.com, Ozon.ru, Books.ru и т. д.).</p>
            @else
