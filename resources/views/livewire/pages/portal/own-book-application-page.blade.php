<main class="flex-1 content mb-32">
    ...
    <section class="mb-24 flex gap-12 lg:flex-col lg:text-center lg:items-center">
        ...
        <div class="container flex flex-col w-fit px-4 h-fit">
            ...
            @endforeach
            <x-ui.link :navigate="false" data-check-logged href="{{route('account.own_book.create')}}" class="my-4 py-2 font-medium !text-2xl tracking-wide">Начать издание!</x-ui.link>
        </div>
    </section>
