<div style="max-width: 1200px; width:90%;display: flex;flex-wrap: wrap;">
    ...
    <form wire:submit.prevent="storeWork(Object.fromEntries(new FormData($event.target)))"
        ...
        <div class="add-work-form">
            ...
            <div style="display: flex; justify-content: space-between; flex-wrap: wrap;">
                ...
                <select wire:ignore style="flex: 1; margin-top:20px; margin-right: 10px;" wire:model="work_type" name="work_type"
                        id="work_type">
            ...
            <button style="width: 100%; margin-top:20px;" type="submit" class="show_preloader_on_click button">Создать
            </button>
        </div>
    ...
    <div wire:ignore class="cropped_result_block">
        ...
        <a style="margin-top:10px;" id="delete_pic_preview" class="link">Удалить</a>
    </div>
