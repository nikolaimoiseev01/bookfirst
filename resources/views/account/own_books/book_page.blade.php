                ...
                <div class="info">
                    <div class="part_part">
                        ...
                        @if($own_book['text_design_price'] > 0 || $own_book['text_check_price'] > 0 || $own_book['cover_price'] > 0)
                            <br><p style="margin: 0;">Необходимо:</p>
                            <ul>
                ...
                @elseif ($own_book['own_book_status_id'] === 2)
                    <div style="display: flex;">
                        ...
                        <div style="padding: 10px; width:90%;" class="participation-outputs">
                            ...
                            <p><i>*На данном этапе оплата производится за все услуги, кроме печати, так как цена
                            ...
                            <div
                                ...
                                <p style="font-size: 20px;">
                                    ...
                                    @if ($own_book['own_book_cover_status_id'] === 2)
                                        ...
                                        проверки. Сейчас необходимо скачать файл и проверить его.
                    ...
                    @elseif ($own_book['own_book_status_id'] === 9 && $own_book->printorder['paid_at'] == null)
                        <div class="no-access">
                            <p> Поздравляем! Весь заказ печатных экземпляров был успешно отправлен!
                                ...
                                <br><b> Сейчас мы заблокировали возможность получения экземпляров.
