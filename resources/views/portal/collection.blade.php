            ...
            <div class="right-collection-info">
                ...
                <div class="col-card">
                    <div class="container">
                        ...
                        <div class="row">
                            <a style="    font-size: 25px; padding: 3px 35px;" href="{{route('participation_create',$collection['id'])}}" class="log_check button">Принять
                                участие!</a>
                        </div>
                    </div>
                </div>
                ...
                <div id="process" class="process">
                    <div class="process-slider">
                        ...
                        <div class="step">
                            ...
                            <p> Сразу после заполнения заявки, Вы будете перенаправлены на отдельную страницу конкретно Вашего участия в личном кабинете.
                        ...
                        <div class="step">
                            ...
                            <p>После нашей проверки на странице участия в личном кабинете будет доступна форма оплаты.
                                ...
                                (Оплата любой картой, Yandex money, Western Union, PayPal, номером телефона и другие)</p>
                        </div>
                        <div class="step">
                            <p>Шаг 4. Предварительная проверка</p>
                            <p><a class="triger_dates link">В указанную дату</a> на странице вашего участия в личном кабинете будет открыт блок предварительной проверки.
                                В этом блоке можно будет скачать PDF файл сборника и указать необходимые изменения в специальной форме.
                                Как только исправление будет учтено, Вы будете об этом оповещены.</p>
                        </div>
                        <div class="step">
                            <p>Шаг 5. Получение печатного экземпляра</p>
                            <p>Если кроме участия Вы заказывали печатные экземпляры, то <a class="triger_dates link">в указанную дату</a> на странице вашего участия в личном кабинете будет доступна ссылка для отслеживания сборника.
                    ...
                    <div class="calc-inputs">
                        <div class="calc-row">
                            ...
                            <select id="pages" name="pages">
                                <option value="800">1-7</option>
                                <option value="1600">8-14</option>
                                <option value="2000">15-21</option>
                                <option value="3000">22-28</option>
                            </select>
                        </div>
                        ...
                        <div class="calc-row no-wrap">
                            <div class="check-block">
                                <label for="text-check">
                                    <p>
                                       <span style="margin-right: -6px; margin-left: 8px; position: relative !important;"
                                             class="question-mark tooltip"
                                             title="Включает в себя проверку орфографии и пунктуации текста.">
                                            <svg style="vertical-align: middle;" id="question-circle" data-name="Capa 1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="calc-outputs">
                        <div class="prices-seperate">
                            <div class="participation-price">
                                <div id="part_price" class="price-number">800</div>
