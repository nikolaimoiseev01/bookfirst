                ...
                <div id="process" class="process">
                    <div class="process-slider">
                        ...
                        <div class="step">
                            ...
                            <p>После того, как заявка была отправлена, произведения проходят цензуру. В них не должно быть
                            призывов к терроризму или иного запрещенного контента.</p>
                        </div>
                        <div class="step">
                            <p>Шаг 3. Оплата участия</p>
                            <p>После нашей проверки на странице участия в личном кабинете будет доступна оплата.</p>
                        </div>
                        <div class="step">
                            <p>Шаг 4. Заполнение заявки</p>
                            <p>Нажав на “Принять участие”, в личном кабинете необходимо заполнить заявку. При заполнении
                                можно сразу указать необходимое количество печатных экземпляров.</p>
                        </div>
                    </div>
                </div>
