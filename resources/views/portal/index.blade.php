        ...
        <div class="ex-right">
            <div class="project-wrap">
                <div id="ex_0" class="project active_text">
                    ...
                    <p class="ex_desc letters">
                        Более 30-ти изданных выпусков сборников стихотворений современных поэтов.
                        Взгляды поэтов неоднозначны, многослойны и объёмны, они олицетворяют настоящую жизнь.
                ...
                <div id="ex_1" class="project">
                    ...
                    <p class="ex_desc letters">
                        ...
                        В сборнике «Сокровенные мысли» мы собираем авторов, проза которых заставит
                        глубоко окунуться в мир непостижимого, которым мы окружены.
                    </p>
                </div>
