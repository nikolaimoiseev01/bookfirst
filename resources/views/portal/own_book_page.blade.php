                    ...
                    <div class="process-slider">
                        <div class="step">
                            ...
                            <p> Нажмите "Подать заявку", чтобы начать процесс издания.
                                ...
                                <br><i>Оплата производится только после подтверждения нашей готовности включить Вас в сборник!</i>
                            </p>
                        </div>
                        <div class="step">
                            <p>Страница издания</p>
                            <p> Сразу после заполнения заявки, Вы будете перенаправлены на отдельную страницу конкретно Вашего издания в личном кабинете.
                                Это главная страница издания, на ней Вы сможете отслеживать статусы издания, а также любые изменения в процессе.
                        ...
                        <div class="step">
                            ...
                            <p>После того, как заявка была отправлена, произведения проходят цензуру.
                                ...
                                Сразу после нашего подтверждения заявки, Вы получите оповещения (Email в том числе) о необходимости оплаты.</p>
                        </div>
                        <div class="step">
                            ...
                            <p>После нашей проверки на странице издания в личном кабинете будет доступна форма оплаты.
                                ...
                                На этом этапе оплата производится за все услуги кроме печати книги, так как параметры внутреннего блока могут поменяться в процессе редактуры.</p>
                        </div>
                        <div class="step">
                            <p>Шаг 4. Предварительная проверка</p>
                            <p>Если была заказаны услуга редактирвоания внутреннего блока или создания обложки,
                                то в течение 14-ти рабочих дней после оплаты на странице Вашего издания в личном кабинете будет доступен блок предварительной проверки.
                                В нем Вы сможете в свободной форме указать все нобходимые изменения или утвердить его, если все будет устраивать.
                            </p>
                        </div>
                        <div class="step">
                            <p>Шаг 5. Оплата печати</p>
                            <p>Как только макеты (внутренний блок и обложка) будут полностью утверждены, будет доступна оплата печати в случае заказа печатных экземпляров.
                                Сразу после оплаты книги будут отправлены в печать. В течение 14-ти рабочих дней книги будут напечатаны и отправлены автору.
                            </p>
                        </div>
                        <div class="step">
                            <p>Шаг 5. Получение печатного экземпляра</p>
                            <p>Как только книги будут напечатаны, на странице вашего издания в личном кабинете будет доступна ссылка для отслеживания.
                                По умолчанию мы посылаем сборники Почтой России, но при необходимости готовы использовать любую другую транспортную компанию.</p>
                        </div>
                    </div>
                </div>
                ...
                <div id="calculator" class="hide">
                    ...
                    <div style="width: 60%; padding-bottom: 20px; padding-right: 50px;" class="calc-inputs">
                        ...
                        <div class="calc-row no-wrap">
                            <p style="    display: flex; align-items: center; justify-content: space-between;">Обложка
                            <div style="margin-left: 10px;" class="switch-wrap">
                        ...
                        <div id="price-parts-wrap">
                            <div class="participation-price">
                                ...
                                <div class="participation-price-desc">
                                    <div>
                                        <p>работа с макетом (</p><p id="pages_output">0</p><p>&nbsp;стр.)</p>
                                    </div>
    ...
    <script>
        ...
        $('.up-down').on('change', function () {
            ...
            if ($(this).val() === 'show' || $(this).prop('checked') & $(this).prop('type') === 'checkbox') {
                $('.' + $(this).attr('name')).show();
                var height_block_plus = $('.' + $(this).attr('name')).innerHeight();
                var height_block = $('.list-wrap').innerHeight();
