<div class="navbar">
    ...
    width: 100%;">
        <div class="hamburger-menu">
            ...
            <ul class="menu__box">
                ...
                <a id="to_social_link" style="display:flex; align-items: center;" href="{{route('homePortal')}}">
                    <p>
                        <i>
                                    <span class="menu__item" style=" color: var(--green);">
                            Издательство
                        </span>
    ...
    align-items: center;">
            ...
            <a id="on_social_link" style="display:flex; align-items: center;" href="{{route('social.home')}}">
            ...
            <a id="to_publish_link" style="display:flex; align-items: center;" href="{{route('homePortal')}}">
                <p>
                    <i>
                                    <span
        ...
        <div class="menu">
            ...
            <a style="margin-top: 2px;" data-for-modal="modal_site_search" class="show_modal"><i class="fa fa-search"></i></a>

            <div style="display: none;" id="modal_site_search" class="cus-modal-container">
                <h3 style="text-align: center; margin-bottom: 10px;">
                    Поиск по всему сайту<br>
                </h3>
                <div style="flex-wrap: wrap; flex-direction: column; align-items: center;  display:flex;">
                    <form style="width: 100%; flex-direction: column; align-items: center; display:flex; flex-wrap: wrap;"
                          action="{{ route('site_search', '') }}"
                        ...
                        <input  style="width: 100%;" type="text" class="form-control_social" id="search_site_input" name="search_input" required>
                        <button style="margin-top: 10px;" class="show_preloader_on_click button_social" type="submit">Искать</button>
                        <script>
            ...
            <script>
                $('form').submit(function () {
                    ...
                    button.css('width', button.innerWidth())
                    button.css('height', button.innerHeight())
                    button.css('background', 'none');
                    button.css('color', 'white');
                    button.css('disabled', true);
                    button.css('cursor', 'wait');
                    button.html('<span class="button--loading"></span>')
                })
...
{{--                    $(this).children('form').css('width', '200px');--}}
{{--                })--}}

{{--                $(document).mouseup(function (e) {--}}
{{--                    var container = $(".cus_search");--}}

{{--                    // if the target of the click isn't the container nor a descendant of the container--}}
{{--                    if (!container.is(e.target) && container.has(e.target).length === 0) {--}}
{{--                        $('.cus_search').children('form').css('width', '45px');--}}
{{--                    }--}}
{{--                });--}}
{{--            </script>--}}

            <a class="menu-link" href="{{route('social.all_works_feed')}}">Произведения</a>
            <a class="menu-link log_check" href="{{route('work.index')}}">Разместить</a>
            <a class="menu-link" href="{{route('actual_collections')}}">Конкурсы</a>
            <div class="account">
                @guest
    ...
    @yield('user_header_block_scroll')
