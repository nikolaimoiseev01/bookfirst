<div class="navbar">
    ...
    <div class="hamburger-menu">
        ...
        <ul class="menu__box">
            ...
            <li><a class="menu__item" href="{{route('old_collections')}}">Авторы</a></li>
    ...
    <a style="display:flex; align-items: center;" href="{{route('social.home')}}">
    ...
    <div class="menu">
        ...
        <div style="position:relative;">
            <span class="menu-link" id="collection_menu_link" style="margin-left: 0 !important;">Авторы</span>
        ...
        <div style="position:relative;">
            <span class="menu-link" id="own_books_menu_link">Произведения</span>
        ...
        <a class="menu-link" href="{{route('about')}}">Разместить</a>
        <a class="menu-link" href="/#reviews-block">Конкурсы</a>
        <div class="account">
            @guest
