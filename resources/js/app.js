...
if (confirmPayment) {
    ...
    switch (confirmPayment) {
        case 'collection_participation':
            ...
            html = '<p>Следующий шаг - дождаться этапа предварительной проверки. Если статус не изменился, попробуйте обновить страницу через пару минут.</p>';
            break;

        case 'own_book_without_print':
            title = 'Оплата прошла успешно 💫';
            html = '<p>Ваша книга принята в работу. Следующий шаг - дождаться этапа предварительной проверки. Если статус не изменился, попробуйте обновить страницу через пару минут.</p>';
            break;
