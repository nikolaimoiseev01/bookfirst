	...
	protected function imb_tables($n, $size) {
		...
		for ($count = 0; $count < 8192; ++$count) {
			...
			if ($bit_count == $n) {
				...
				if ($reverse >= $count) {
					// If count is symmetric, place it at the first free slot from the end of the list.blade.php.
					// Otherwise, place it at the first free slot from the beginning of the list.blade.php AND place $reverse ath the next free slot from the beginning of the list.blade.php
					if ($reverse == $count) {
						$table[$lui] = $count;
						--$lui;
					} else {
