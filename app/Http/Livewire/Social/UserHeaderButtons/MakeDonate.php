...
class MakeDonate extends Component
{
    public $user_to;
    public $user_to_wallet;

    public $show_topup = false;

    public function render()
    {
        $this->user_from_wallet = Auth::user()->UserWallet ?? null;
        return view('livewire.social.user-header-buttons.make-donate', [
            'user' => $this->user_to,
    ...
    public function toggle_topup() {
        $this->show_topup = !$this->show_topup;
        $this->emit('$refresh');
    }
