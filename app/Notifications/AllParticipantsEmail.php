...
class AllParticipantsEmail extends Notification
{
    use Queueable;
     ...
     * @return void
     */
    public function __construct($subject, $user_name, $email_text, $email_button_link)
    {
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->action('Ваша страница участия', url($this->email_button_link));
    }
